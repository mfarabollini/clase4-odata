		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData Vuelos",
									"targetURL": "#exaccsclase4odata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"exaccsclase4odata-display": {
								"semanticObject": "exaccsclase4odata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exaccs.clase4odata",
									"url": sap.ui.require.toUrl("exaccs/clase4odata")
								}
							}
						}
					}
